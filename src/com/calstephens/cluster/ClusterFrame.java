...
public class ClusterFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        rulesTable.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null,  new Boolean(false),  new Boolean(false),  new Boolean(false),  new Boolean(false)},
            ...
            new String [] {
                "Name", "Maximum", "K", "1st", "2nd", "3rd", "4th", "5th"
            }
        ) {
            Class[] types = new Class [] {
                java.lang.String.class, java.lang.Integer.class, java.lang.Boolean.class, java.lang.Boolean.class, java.lang.Boolean.class, java.lang.Boolean.class, java.lang.Boolean.class, java.lang.Boolean.class
            };
            boolean[] canEdit = new boolean [] {
	...
	if(participants.size() > 0) {
		...
		rulesTable.setValueAt(true, i, 7);
	    }
	...
	for(int i = 0; i < Participant.clusterNames.size(); i++) {
		...
		cluster.allowK = (Boolean) rulesTable.getValueAt(i, 2);
		cluster.allow1 = (Boolean) rulesTable.getValueAt(i, 3);
		cluster.allow2 = (Boolean) rulesTable.getValueAt(i, 4);
		cluster.allow3 = (Boolean) rulesTable.getValueAt(i, 5);
		cluster.allow4 = (Boolean) rulesTable.getValueAt(i, 6);
		cluster.allow5 = (Boolean) rulesTable.getValueAt(i, 7);
	    }
	}
